		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Critical Part Analysis",
									"targetURL": "#hac2buildcriticalpartanalysis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hac2buildcriticalpartanalysis-display": {
								"semanticObject": "hac2buildcriticalpartanalysis",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hac2build.criticalpartanalysis",
									"url": sap.ui.require.toUrl("hac2build/criticalpartanalysis")
								}
							}
						}
					}
