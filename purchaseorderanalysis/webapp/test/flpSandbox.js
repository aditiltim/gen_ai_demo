		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hac2buildpurchaseorderanalysis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hac2buildpurchaseorderanalysis-display": {
								"semanticObject": "hac2buildpurchaseorderanalysis",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hac2build.purchaseorderanalysis",
									"url": sap.ui.require.toUrl("hac2build/purchaseorderanalysis")
								}
							}
						}
					}
