		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hac2buildsalesorderanalysis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hac2buildsalesorderanalysis-display": {
								"semanticObject": "hac2buildsalesorderanalysis",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hac2build.salesorderanalysis",
									"url": sap.ui.require.toUrl("hac2build/salesorderanalysis")
								}
							}
						}
					}
