		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hac2buildalertmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hac2buildalertmanagement-display": {
								"semanticObject": "hac2buildalertmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hac2build.alertmanagement",
									"url": sap.ui.require.toUrl("hac2build/alertmanagement")
								}
							}
						}
					}
