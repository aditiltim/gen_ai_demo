		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hac2buildproductionorderanalysis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hac2buildproductionorderanalysis-display": {
								"semanticObject": "hac2buildproductionorderanalysis",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hac2build.productionorderanalysis",
									"url": sap.ui.require.toUrl("hac2build/productionorderanalysis")
								}
							}
						}
					}
